...
export default function Engine(){
	//Engine Valiables
	var enginescrean = null;
	useEffect(()=>{ enginescrean = document.querySelector("#battlefield")})
	var maxX;
	var maxY;
	var objOldZIndex = 0;
	var keyDown;
	...
	*/
	...
	function setMaxHeightWidth(){
		useEffect(()=>{
			maxX = window.innerWidth-window.innerWidth-parseInt(enginescrean.css('width'));
			maxY = window.innerHeight-window.innerHeight-parseInt(enginescrean.css('height'));
		})
	}
