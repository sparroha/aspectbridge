...
export default function AspectBridge() {
    return <>
        ...
        <ContainerOverlay>Cildren ... of the Els
            <Card>
                <Card.Title>Playing Card</Card.Title>
                <Card.Text>Card of the Cards</Card.Text>
            </Card>
...
function DynamicInfo(){
    ...
    return <Col md={10} id='home' className={"well-sm white-back scroll"}>
                <Row className={"h10"}><h3 className={'img-banner'}>Here</h3></Row>
                <hr />
            </Col>
}
