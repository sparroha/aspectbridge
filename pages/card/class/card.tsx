...
export default function Card(props: FTCardPropsPartial ) {
    const { name, order, image, strimage, type, click, color, logo, children } = props
    const colorPalette = {
        red: '#af4261',
        lightred: '#df4261',
        yellow: '#f3ec78',
    ...
    return <button id={'card-container'} onClick={click} style={{
            ...
            padding: '10px',
            margin: '10px',
            backgroundImage: `linear-gradient(45deg, ${colorPalette.blue}, ${colorPalette.yellow}, ${colorPalette.purple}, ${colorPalette.red})`
    }}>
