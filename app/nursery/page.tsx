...
export default function Plants({params, searchParams}){
    ...
    const data = [
        ...
        {name: 'Turkey', type:'Beast', subtype:'Bird Poltry', children:<><i>"Gobble!"</i></>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Male_wild_turkey_%28Meleagris_gallopavo%29_strutting.jpg/600px-Male_wild_turkey_%28Meleagris_gallopavo%29_strutting.jpg', href: 'https://en.wikipedia.org/wiki/Turkey_(bird)'},
        ...
        {name: 'White-Tailed Deer', type:'Beast', subtype:'Deer', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/White-tailed_deer.jpg/789px-White-tailed_deer.jpg', href: 'https://en.wikipedia.org/wiki/White-tailed_deer'},
        {name: 'Box Turtle', type:'Beast', subtype:'Turtle', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/6/6c/Eastern_Box_Turtle2.jpg', href: 'https://en.wikipedia.org/wiki/Box_turtle'},
        {name: 'Snapping Turtle', type:'Beast', subtype:'Turtle', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Snapping_Turtle_Heinz.png/800px-Snapping_Turtle_Heinz.png', href: 'https://en.wikipedia.org/wiki/Common_snapping_turtle'},
        {name: 'Armadillo', type:'Beast', subtype:'Nine-banded', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Dasypus_novemcinctus.jpg/800px-Dasypus_novemcinctus.jpg', href: 'https://en.wikipedia.org/wiki/Nine-banded_armadillo'},
        {name: 'Opossum', type:'Beast', subtype:'Marsupial', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/2/25/Rabipelao2.jpg', href: 'https://en.wikipedia.org/wiki/Common_opossum'},
        {name: 'Black Rat', type:'Beast', subtype:'Rodent Rat', children:<>"Rattus rattus"</>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Roofrat_Hagenbeck_02.jpg/220px-Roofrat_Hagenbeck_02.jpg', href: 'https://en.wikipedia.org/wiki/Black_rat'},
        {name: 'Brown Rat', type:'Beast', subtype:'Rodent Rat', children:<>"Norway rat"</>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Rattus_norvegicus_-_Brown_rat_02.jpg/800px-Rattus_norvegicus_-_Brown_rat_02.jpg', href: 'https://en.wikipedia.org/wiki/Brown_rat'},
        ...
        {name: 'Giant Stag Beetle', type:'Bug', subtype:'Insect Beetle', children:<i>"Elephant etag beetle"</i>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Lucanus_elaphus_142395158.jpg/750px-Lucanus_elaphus_142395158.jpg', href: 'https://en.wikipedia.org/wiki/Lucanus_elaphus'},
        ...
        {name: 'Weeping Willow', type:'Plant', subtype:'Tree', children:<>"Babylon willow"</>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/Ch%C3%A2teau_de_Chenonceau_-_jardin_Russell-Page_%2801%29.jpg/450px-Ch%C3%A2teau_de_Chenonceau_-_jardin_Russell-Page_%2801%29.jpg', href: 'https://en.wikipedia.org/wiki/Salix_babylonica#Horticultural_selections_and_related_hybrids'},
        {name: 'Canada Wild Lettuce', type:'Plant', subtype:'Letuce', children:<>"Tall lettuce"</>, img: 'https://calphotos.berkeley.edu/imgs/512x768/0000_0000/0506/2241.jpeg', href: 'https://en.wikipedia.org/wiki/Lactuca_canadensis'},
        {name: 'Green Snake', type:'Beast', subtype:'Serpent', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Opheodrys_aestivusPCCP20030524-0823B.jpg', href: 'https://en.wikipedia.org/wiki/Opheodrys'},
        {name: 'Tomato Hornworm', type:'Bug', subtype:'Caterpillar', children:<>Morph: Five-spotted Hawkmoth</>, img: 'https://upload.wikimedia.org/wikipedia/commons/5/50/Tomato_hornworm.jpg', href: 'https://en.wikipedia.org/wiki/Manduca_quinquemaculata'},
        {name: 'Five-spotted Hawkmoth', type:'Bug', subtype:'Moth', children:<>Morph: Tomato Hornworm</>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Manduca_quinquemaculata_MHNT_CUT_2010_0_116_Schuylkill_Haven%2C_Schuylkill_Co._Penna_male_dorsal.jpg/800px-Manduca_quinquemaculata_MHNT_CUT_2010_0_116_Schuylkill_Haven%2C_Schuylkill_Co._Penna_male_dorsal.jpg', href: 'https://en.wikipedia.org/wiki/Manduca_quinquemaculata'},
