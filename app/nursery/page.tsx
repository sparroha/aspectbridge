...
export default function Plants({params, searchParams}){
    ...
    const data = [
        ...
        {name: 'Black Rat', type:'Animal', subtype:'Rodent Rat', children:<>"Rattus rattus"</>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Roofrat_Hagenbeck_02.jpg/220px-Roofrat_Hagenbeck_02.jpg', href: 'https://en.wikipedia.org/wiki/Black_rat'},
        {name: 'Brown Rat', type:'Animal', subtype:'Rodent Rat', children:<>"Norway rat"</>, img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Rattus_norvegicus_-_Brown_rat_02.jpg/800px-Rattus_norvegicus_-_Brown_rat_02.jpg', href: 'https://en.wikipedia.org/wiki/Brown_rat'},
        ...
        {name: 'Green Snake', type:'Animal', subtype:'Serpent', children:<></>, img: 'https://upload.wikimedia.org/wikipedia/commons/0/0f/Opheodrys_aestivusPCCP20030524-0823B.jpg', href: 'https://en.wikipedia.org/wiki/Opheodrys'},
