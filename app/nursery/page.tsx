...
export default function Plants({params, searchParams}){
    ...
    const data = [
        ...
        {order: 0, name: 'Canna Indica', type:'Plant', subtype:'', children:<>Indian Shot, Arrow Root</>, img: wikiImg+'1/1c/Cinnamon-bellied_flowerpiercer_%28Diglossa_baritula%29_male_on_Indian_shot_%28Canna_indica%29_Finca_El_Pilar.jpg', href: wiki+'Canna_indica'},
        {order: 0, name: 'Rusty Spider Wasp', type:'Bug', subtype:'Wasp', children:<><b>Greek: Swift Rusty Pilotfish</b><br/>Red-tailed spider hunter</>, img: wikiImg+'d/db/Wasp-Spider_Hunting.jpg', href: wiki+'Tachypompilus_ferrugineus'},
        //{order: 0, name: 'Potato', type:'', subtype:'Nightshade', children:<></>, img: wikiImg+'', href: wiki+''},
        //{order: 0, name: 'Sweet Potato', type:'', subtype:'Morning Glory', children:<></>, img: wikiImg+'', href: wiki+''},
